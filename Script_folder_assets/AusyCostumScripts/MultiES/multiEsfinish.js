...
*/
  ...
  var g_buttonPosMenu = [1609, 2094];
  var g_menuCatchTheGold = [533, 1322];
  var g_menuWhaterRiches = [1388, 1307];
  var g_menuKingdomGems = [522, 1764];
  var g_menuRacinGo = [1405, 1754];
  ...
  function onPrizeWon(total, line,  symbol, value, freeSpins, bonus)
    ...
    function SwitchGame(game)
    {
      ...
      if (typeof (game) == "undefined") {
          ...
          print("NEw game: "+game);
          print("current_game_index: "+ current_game_index);
  ...
  function StartPlay()
  {
      ...
      v_startPlayRetry++;
      print("StartPlay times: "+ v_startPlayRetry);
      ...
      machine.setTimeout('playtimeout2',4000,'StartPlay();');
      if(g_useTouch == true)
      {
  ...
  function onInPlay()
  {
      ...
      machine.removeTimer('playtimeout2');
      v_startPlayRetry = 0;
      v_hasBonus = false;
  ...
  function onCashIn()
  {
    ...
    if(g_PointSystem == true){
      print("Bateu true");
        //Start conversion
        machine.setTimeout('startPointConv',1000,'StartPointConversion();');
    }
    if(v_currentGame == "gallery") {
      print("Bateu gallery");
        machine.setTimeout('startPointConv',1000,'SwitchGame();');
    }
    else {
      print("bateu else");
    }
  ...
  {
    print("onHandpayDone: "); //this no working
      machine.setTimeout('creditsIN2',2000,'StartPlay();');
  }